                ...
                return (
                  <div key={rec.id} className="flex gap-4 rounded-lg border border-stone-200 dark:border-stone-800 p-4 bg-amber-50/50 dark:bg-amber-950/20">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-stone-600 mt-1">Recommended by <span className="font-medium text-foreground">{from}</span></p>
              ...
              {read.map((rec) => {
                ...
                return (
                  <div key={rec.id} className="flex gap-4 rounded-lg border border-stone-200 dark:border-stone-800 p-4 opacity-60">
                    ...
                    <div className="flex-1 min-w-0">
                      <a href={`/book/${bookKey}`} className="text-sm font-medium text-stone-950 hover:underline dark:text-stone-50">{rec.title}</a>
