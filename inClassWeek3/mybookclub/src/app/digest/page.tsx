    ...
    <div className="flex-1">
      <div className="border-b border-stone-200 dark:border-stone-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
          <h1 className="text-3xl sm:text-5xl font-bold tracking-tight text-heading">
            Weekly Digest
          </h1>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        {recentlyFinished.length > 0 && (
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-heading mb-4">Recently Finished</h2>
        ...
        {/* Activity feed */}
        <section>
          <h2 className="text-xl font-semibold text-heading mb-4">This Week</h2>
          {recent.length === 0 ? (
