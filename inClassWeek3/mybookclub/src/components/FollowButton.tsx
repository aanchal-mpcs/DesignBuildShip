    ...
    <div className="flex items-center gap-4 mt-4">
      <div className="flex gap-4 text-sm">
        <span className="text-stone-600 dark:text-stone-400">
          <span className="font-semibold text-heading">{followers}</span> {followers === 1 ? "follower" : "followers"}
        </span>
        <span className="text-stone-600 dark:text-stone-400">
          <span className="font-semibold text-heading">{following}</span> following
        </span>
      </div>
